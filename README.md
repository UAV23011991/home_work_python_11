...
# 1. Поиск и построение графика функции.
...
Находим каждый корень, до тех пор пока функция не преодолеет "0", после чего уточним значение с помощью функции nsolve().
...
# 4. Определение интервалов возростания и убывания функции.

**Данная функция имеет 6 интервалов возростания/убывания на отрезке х ∈ [—10, 10]:**

1. Убывает при x ∈ [-10, -6,83..]
2. Возрастает при x ∈ [-6,83.., -4,17..]
3. Убывает при x ∈ [-4,17.., 1,7..]
4. Возрастает при x ∈ [1,7.., 3,82..]
5. Убывает при x ∈ [3,82.., 7,001..]
6. Возрастает при x ∈ [7,001.., 9,5]

# 5. Промежутки, на которых f(x) > 0 и f(x) < 0.
